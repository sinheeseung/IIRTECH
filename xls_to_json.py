...
key_list = ['word', 'sense_no', 'definition', 'word_unit', 'word_type', 'original_language', 'language_type', 'pronunciation', 'conjugation', 'conjugation_pro', 'abbreviation', 'abbreviation_pro', 'origin', 'allomorph', 'pos',
           'type', 'grammar', 'cat', 'example', 'source', 'origin', 'relation_word', 'translation', 'region']
